...
public class GoiYHomNayAdapter extends RecyclerView.Adapter<GoiYHomNayAdapter.GoiYHomNayViewHolder> {

    Context context;
    List<Medicine> list;
    int layout;

    public GoiYHomNayAdapter(Context context, List<Medicine> list, int layout) {
    ...
    @NonNull
    @Override
    public GoiYHomNayViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_listview_buy, parent, false);
        return new GoiYHomNayViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull GoiYHomNayViewHolder holder, int position) {
    ...
    public class GoiYHomNayViewHolder extends RecyclerView.ViewHolder{
        ...
        public GoiYHomNayViewHolder(@NonNull View itemView) {
            super(itemView);
